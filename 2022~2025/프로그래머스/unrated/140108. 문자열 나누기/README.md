...
##회고
변수명을 좀 단순하게 설정해야겠다. temp 라는 임시 변수를 사용하여 중간 결과값을 저장하고, 횟수를 늘리는 방식으로 풀었다. 문제 자체에 문자열을 분리하라는 게 있어서, split함수로 분리하고 삽질했는데 결국은 횟수를 묻는거라 그럴 필요가 없었다... 문제가 요구하는 걸 잘 파악하기!
